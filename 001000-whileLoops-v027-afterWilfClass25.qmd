...
## Infinite loop - press the STOP button (and/or ESC key)
...
## Practice with finding errors in loops
...
## More practice finding errors in loops
...
## There are MANY ways to write the same function
...
## More practice - mysum(NUMS) &nbsp;&nbsp;&nbsp;&nbsp; blastoff(SECONDS)
```{r}
###############################################################################
...
## another example - primesUpTo(maxNum)
...
## another example - firstNPrimes ( N )
...
## Another example - flightsBeforeReturning() , itineraray()
...
## example - primesUpTo() with nested loops
...
## example - firstNPrimes() with nested loops
...
## More practice - drawing shapes with numbers
