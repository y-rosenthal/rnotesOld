...
company [ hq == "ny" | hq =="ca"]   # these are the companies
hq [ hq == "ny" | hq =="ca"]        # and these are their headquarters
...
# NOTE - you must include the (parentheses) as shown to deal with order of operations
company [ (sector == "tech" | sector == "pharma") & close-open >= .1*open  ]

# NOTE - the following is wrong because of order of operations
#company [ sector == "tech" | sector == "pharma" & close-open >= .1*open  ]

# ANSWER - (b) Show their sectors   (another command)
sector [ (sector == "tech" | sector == "pharma") & close-open >= .1*open  ]


# ANSWER - (c) Show their open values  (another command)
open [ (sector == "tech" | sector == "pharma") & close-open >= .1*open  ]

# ANSWER - (d) Show their close values   (another command) 
close [ (sector == "tech" | sector == "pharma") & close-open >= .1*open  ]

# ANSWER - (e) Show the percent increases of the tech and pharma companies whose stock increased in value by 10% or more

# One way - all in one command
((close - open) / open) [ (sector == "tech" | sector == "pharma") & close-open >= .1*open  ]

# Another way - in two commands
pctIncreases = ((close - open) / open)
pctIncreases [(sector == "tech" | sector == "pharma") & close-open >= .1*open  ]
